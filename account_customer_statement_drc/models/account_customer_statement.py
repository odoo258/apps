...
class ReportPartnerLedger(models.AbstractModel):
    _name = 'report.account_customer_statement_drc.report_customer_statement'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('account_customer_statement_drc.report_customer_statement', docargs)
